...
const fs = require("fs");
let school = {}
let e = { //events模块 vue $on $off once
    arr: [],
    on: function(fn){
        this.arr.push(fn);
    },
...
```
- 观察者模式（观察者和被观察者有关系，订阅发布模式里订阅和发布之间没关系）
...
let s = new Subject("小宝宝") //被观察者：小宝宝
let o1 = new Observer("我") //观察者：我
let o2 = new Observer("我老公") //观察者：我老公
